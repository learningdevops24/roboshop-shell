...
##### Change these values ###
ZONE_ID="Z05294141CWOJI580UTLS"
DOMAIN="learningdevops24.online"
SG_NAME="allow-all"
env=dev
#############################
...
create_ec2() {
  PRIVATE_IP=$(aws ec2 run-instances \
      ...
      --instance-type t2.micro \
       --tag-specifications "ResourceType=instance,Tags=[{Key=Name,Value=${COMPONENT}}, {Key=Monitor,Value=yes}]" "ResourceType=volume,Tags=[{Key=Name,Value=${COMPONENT}}]"  \
